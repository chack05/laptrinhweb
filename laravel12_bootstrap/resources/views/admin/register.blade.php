...
<meta name="theme-color" content="#7952b3">
  ...
  >
      <a class="p-2 fs-5 link-menu" href="login.html">Home</a>
      <hr />
  ...
  <section class="container-fluid main mt-5">
      <div class="border border-black border-1 p-4">
          ...
          <form action="{{ route('admin.register') }}" method="POST" role="form">
             @csrf
              ...
              <div class="form-group pb-4 ps-4 pe-4">
                  <label class="fs-6" for="pwd">Nhập lại mật khẩu:</label>
              ...
              <div class="form-group pb-4 ps-4 pe-4">
                  <label class="fs-6" for="pwd">age:</label>
              ...
              >
                  <a href="{{ route('admin.login') }}" class="me-4 text-decoration-none"
                  >Đã có tài khoản</a
                  >
